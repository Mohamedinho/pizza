package com.example.myrecipeapp.service;

import com.example.myrecipeapp.data.Repository;
import com.example.myrecipeapp.model.Pizza;
import com.example.pizzaapp.R; // Assurez-vous d'importer la bonne classe R
...
public class RecipeManager implements Repository<Pizza> {
    ...
    private void populate() {
        recipes.add(new Pizza("BARBECUED CHICKEN PIZZA", 3.0,
        ...
        recipes.add(new Pizza("BRUSCHETTA PIZZA ", 5.0,
        ...
        recipes.add(new Pizza("SPINACH PIZZA", 2.0,
        ...
        recipes.add(new Pizza("DEEP-DISH SAUSAGE PIZZA ", 8.0,
        ...
        recipes.add(new Pizza("HOMEMADE PIZZA", 4.0,
        ...
        recipes.add(new Pizza("PESTO CHICKEN PIZZA",3.0,
        ...
        recipes.add(new Pizza("LOADED MEXICAN PIZZA",3.0,
        ...
        recipes.add(new Pizza("BACON CHEESEBURGER PIZZA",2.0,
        ...
        recipes.add(new Pizza("PIZZA MARGHERITA",1.0,
        ...
        recipes.add(new Pizza("PEPPERONI-SAUSAGE STUFFED PIZZA",5.0,
                R.mipmap.pizza10,"45 min",
                "- 1 package (1/4 ounce) active dry yeast\n- ... suite des ingrédients",
                "Description de la pizza pepperoni-saucisse.",
                "STEP 1:\n\n  Préparer la pâte..."));
    }
    ...
    public Pizza update(Pizza p) {
        for (int i = 0; i < recipes.size(); i++) {
            if (recipes.get(i).getId() == p.getId()) {
                recipes.set(i, p);
                return p;
            }
        }
    ...
    public boolean delete(long id) {
        return recipes.removeIf(x -> x.getId() == id);
    }
